...
%{!?rdk_version: %global rdk_version 1.3.1.2}
...
%changelog
* Sat Sep 19 2026 Andrey Romashkin <romashk.andrey@gmail.com> - 1.3.1.2-1
- Fork build 2: RdKafka1C.dll (Windows) rebuilt from the fork sources: OpenSSL 3.5.8,
  librdkafka 2.15.1 with zlib and zstd, secrets masked in the debug log
